...
<div className="container">
      ...
      <div className="row">
        ...
        <div className="col-4 text-center mt-5 welcomeTobeto">
          <span>Tobeto</span>'ya hoş geldin<br/> Name Surname
        </div>
 ...
 <div className="row d-flex justify-content-center mt-3">  
    ...
    Ücretsiz eğitimlerle, geleceğin mesleklerinde sen de yerini al.<br />
    Aradığın  <span className="quote">“</span>İş<span className="quote">”</span>  Burada!
    </div>
</div>
...
<div className="row">
      <div className="col-12 mb-4 mt-3 ">
        <ul className="nav nav-tabs mainTablist justify-content-center p-3" id="myTab" role="tablist">
